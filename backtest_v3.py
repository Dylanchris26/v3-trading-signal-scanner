...
def run_pair(
    ...
    final_index = len(c1) - strategy.V3_EXPIRY_MINUTES - 1
...
def print_report(results: List[Result]) -> None:
    print("\n" + "=" * 68)
    print("IQ OPTION V3 STRATEGY BACKTEST REPORT")
    print("=" * 68)
    ...
    if not results:
        print("No qualifying V3 historical signals were found.")
        print("The V3 gates may simply be too strict for this sample.")
        return
